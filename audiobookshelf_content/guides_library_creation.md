...
**Source:** https://www.audiobookshelf.org/guides/library_creation

**Crawled:** 2025-11-27 21:19:11
...
- Create a library directory for eitheraudiobooksorpodcasts
...
- After creating the library, you can scan for items within the library using the "Scan" button or use the dropdown to scan. The library settings can be adjusted from here as well. Additional information on the scanner can be foundhere.
